    ...
    <div className="min-h-screen bg-gray-50">
          ...
          <div className="text-center">
            {settings?.logoUrl ? (
              <img 
                ...
                alt="Logo" 
                className="w-16 h-16 mx-auto mb-4 object-contain rounded-lg shadow-sm"
              />
            ) : (
      ...
      {settings?.termsAndConditions && (
        <div className="max-w-lg mx-auto px-6 mt-6">
          <Card className="shadow-sm border border-gray-200">
            <CardContent className="p-6">
              <h3 className="text-lg font-semibold text-gray-900 mb-4">Syarat & Ketentuan</h3>
      ...
      {settings?.adminWhatsApp && (
        <div className="max-w-lg mx-auto px-6 mt-6 text-center">
          <Button
            onClick={handleWhatsAppContact}
            className="inline-flex items-center gap-3 bg-green-600 hover:bg-green-700 text-white font-medium px-6 py-3"
      ...
      <div className="max-w-lg mx-auto px-6 mt-8 mb-8">
        <div className="grid grid-cols-2 gap-4">
          <Link href="/alamat-toko">
            <Card className="hover:shadow-md transition-shadow duration-200 border border-gray-200 cursor-pointer">
              <CardContent className="p-6 text-center">
                ...
                <span className="text-gray-900 font-medium text-sm">Alamat Toko</span>
              </CardContent>
            </Card>
          </Link>
          <Link href="/katalog-produk">
            <Card className="hover:shadow-md transition-shadow duration-200 border border-gray-200 cursor-pointer">
              <CardContent className="p-6 text-center">
                <Package className="w-6 h-6 mx-auto mb-3 text-primary" />
                <span className="text-gray-900 font-medium text-sm">Katalog Produk</span>
              </CardContent>
            </Card>
          </Link>
        </div>
